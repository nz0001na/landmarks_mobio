...
% OUT:
% - "outputFileName" a file that will be generated by this tool and 
%                    records the computed facial landmark locations.  
% =========================================================================
% Format:
% 
% Format of the listfile:
%     Each of  line contains the image path, 
%    followed by the [ left, top, width and height ] of the face bounding boxe.
%    (see the example file "list.txt" in the package and 
%     "boundingbox.jpg" illusrates how large the bounding box should be.)
% 
% Format of the outputFile:
%    Each line contrains input image path 
%    followed by the 68 facial landmark locations (x1,y1,x2,y2....x68,y68).
%
%
...
clear; clc;
addpath(genpath('./toolbox-master/')); savepath;
addpath('./TCDCN/');

%% paramter setup
listFileName = 'img_list.txt';
modelFile = 'model.mat';
outputFileName = 'img_output_68.txt';
