...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpus', default=0, type=int, help='specify the gpu ID')
    parser.add_argument('--imgDir', default='../0_final_256_256_9/', type=str, help='path to test images')
    ...
    # parser.add_argument('--prototxt', default='/media/guo/SSD/nazhang/caffe/models/300w/matlab.prototxt', type=str,
    #                     help='path to caffe model prototxt')
    # /media/guo/SSD/nazhang/caffe
